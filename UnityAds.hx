...
class UnityAds {
  ...
  private static var __showBanner:String->Void = function(bannerPlacementId:String){};
	...
	public static function init(appId:String, testMode:Bool, debugMode:Bool) {
		...
		try{
			// JNI METHOD LINKING
			__showVideo = JNI.createStaticMethod("com/unityads/UnityAdsEx", "showVideo", "(Ljava/lang/String;)V");
			...
			__isSupported = JNI.createStaticMethod("com/unityads/UnityAdsEx", "isSupportedUnityAds", "()Z");
